...
101
102
Enter the element you want to search in Linked List:100
Element is found in linked list at 0 position
Do you want to search another element y/n:
y
Enter the element you want to search in Linked List:102
Element is found in linked list at 2 position
Do you want to search another element y/n:
n
